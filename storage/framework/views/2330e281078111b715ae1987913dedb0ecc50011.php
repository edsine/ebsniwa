<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="<?php echo e(route('unit.index')); ?>" class="list-group-item list-group-item-action border-0 <?php echo e((request()->is('unit*') ? 'active' : '')); ?>"><?php echo e(__('Unit')); ?><div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
...
<?php /**PATH C:\Users\shehu.abdullahi\Documents\Apps\Edsine\Projects\niwa\ebsniwa\resources\views/layouts/hrm_setup.blade.php ENDPATH**/ ?>